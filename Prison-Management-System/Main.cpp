...
public:
    ...
    void Attendance();   // Storing attendance of the prisoners
...
void Prison ::SetData()
{
    ...
    cout << "\n";
    cout << "\t\t\t\t\t";
    cout << "Enter the date of entry in DD/MM/YY : ";
    cin >> DateofEntry[o];
    cout << "\t\t\t\t\t";
    cout << "\n\n\n";
    cout << "\t\t\t\t\t";
...
void Prison ::Details()
{
    ...
    cout << "\n============================================================================================================================\n";
    cout << "SR.\tNAME\t\t\tCell Block\tAge\tGender\tHeight\tEye Colour\tCrime\tPunishment\tDateofEntry\n";
    cout << "=============================================================================================================================\n";
    ...
    for (int x = 0; x <= 19; x++)
    {
        ...
        {
            p++;
            cout << p << "\t" << First_Name[x] << "" << Second_Name[x] << "\t\t" << CellNo[x] << "\t\t" << Age[x] << "\t" << Gender[x] << "\t" << Height[x] << "\t" << Eyecolor[x] << "\t\t" << Crime[x] << "\t\t" << Punishmentmonths[x] <<"\t" <<DateofEntry[x]<< endl;
            cout << "\n"
                 << endl;
            c++;
        }
...
void Prison ::Attendance()
{
    ...
    do
    {
        ...
        for (int x = 0; x <= 19; x++)
        {
            if (First_Name[x] != " ")
            {
                cout << First_Name[x] << "" << Second_Name[x] << "\t\t" << CellNo[x] << "\t\t" << Age[x] << "\t" << Gender[x] << "\t" << Height[x] << "\t" << Eyecolor[x] << "\t\t" << Crime[x] << "\t\t" << Punishmentmonths[x] <<"\t\t"<< DateofEntry[x]<< endl;
                cout << "\n"
                     << endl;
                c++;
            }
...
void Prison ::Release()
{
    ...
    do
    {
        ...
        if (c != 0)
        {
            ...
            {
                cout << "\n\t\t\t\t\t";
                cout << "Prisoner is not ready for release"<<endl;
                cout << "\t\t\t\t\t";
                cout << "\n\n\n";
                cout << "\t\t\t\t\t";
                cout<<"do you still wish to release the prisoner.press y(yes) or n(no)"<<endl;
                if(tolower(getch())=='y')
                {
                    goto release;
                }
...
void Prison ::SearchPrison()
{
    ...
    if (CN == info)
    {
        if (First_Name[l] != " ")
        {
            cout << First_Name[l] << "" << Second_Name[l] << "\t\t" << CellNo[l] << "\t\t" << Age[l] << "\t" << Gender[l] << "\t" << Height[l] << "\t" << Eyecolor[l] << "\t\t" << Crime[l] << "\t\t" << Punishmentmonths[l] << "\t\t" << DateofEntry[1]<< endl;
            cout << "\n"
                 << endl;
        }
        else
...
void Prison ::update()
{
    ...
    if (id == info)
    {
        if (First_Name[l] != " ")
        {
            cout<<"Cell No: " <<CellNo[l] << endl;
            cout<<"1:Name : "<< First_Name[l] << "  " << Second_Name[l] <<endl;
            cout<<"2:Age :" << Age[l] << endl;
            cout<<"3:Gender: "<< Gender[l] <<endl;
            cout<<"4:Height: "<< Height[l] <<endl;
            cout<<"5:Eye Color: " << Eyecolor[l] <<endl;
            cout<<"6:Crime:" << Crime[l] <<endl;
            cout<<"7:Punishment: " << Punishmentmonths[l] << endl;
            cout<<"8:Date of Entry :" << DateofEntry[l]<< endl;
            cout<<endl<<endl;
            fflush(stdin);
            cout<<"Select the id of attribute to be edited: ";
            cin>>choice;
            fflush(stdout);
            fflush(stdin);
            switch(choice)
            {
                case 1 :cout<<"Enter new First Name :";cin>>First_Name[l];
                         cout<<"Enter new Second Name :";cin>>Second_Name[l];
                         cout<<endl<<endl;
                         cout<<" Update Succesfull! Press enter to return"<<endl;
                        if(getch)
                         {
                             for (a = 0; a <= 100000000; a++)
                                {
                ...
                case 2  :cout<<"Enter new Age :";cin>>Age[l];
                         cout<<endl<<endl;
                         cout<<" Update Succesfull! Press enter to return"<<endl;
                          if(getch)
                         {
                ...
                case 3 :cout<<"Enter new gender :";cin>>Gender[l];
                         cout<<endl<<endl;
                         cout<<" Update Succesfull! Press enter to return"<<endl;
                          if(getch)
                         {
                ...
                case 4 :cout<<"Enter new height :";cin>>Height[l];
                         cout<<endl<<endl;
                         cout<<" Update Succesfull! Press enter to return"<<endl;
                          if(getch)
                         {
                ...
                case 5 :cout<<"Enter new Eye Color :";cin>>Eyecolor[l];
                         cout<<endl<<endl;
                         cout<<" Update Succesfull! Press enter to return"<<endl;
                          if(getch)
                         {
                ...
                case 6:cout<<"Enter new Crime :";cin>>Crime[l];
                         cout<<endl<<endl;
                         cout<<" Update Succesfull! Press enter to return"<<endl;
                         if(getch)
                         {
                ...
                case 7:cout<<"Enter new Punishmentmonths :";cin>>Punishmentmonths[l];
                         cout<<endl<<endl;
                         cout<<" Update Succesfull! Press enter to return"<<endl;
                          if(getch)
                         {
                ...
                case 8:cout<<"Enter new Date of Entry :";cin>>DateofEntry[l];
                         cout<<endl<<endl;
                         cout<<" Update Succesfull! Press enter to return"<<endl;
                         if(getch)
                         {
                ...
                default:cout<<" Invalid Choice! Press enter to return"<<endl;
                         if(getch)
                            Prison::update();
            }
...
void Prison ::PrisonFile()
{
    ...
    case 1:
        ...
        MyFile_<< "\n============================================================================================================================\n";
        MyFile_<< "SR.\tNAME\t\t\tCell Block\tAge\tGender\tHeight\tEye Colour\tCrime\tPunishment\tDateofEntry\n";
        MyFile_<< "=============================================================================================================================\n";
        ...
        for (int x = 0; x <= 19; x++)
        {
            ...
            {
                p++;
                MyFile_ << p << "\t||" << First_Name[x] <<"\t" << Second_Name[x] << "\t||" << CellNo[x] << "\t||" << Age[x] << "\t||" << Gender[x] << "\t||" << Height[x] << "\t||" << Eyecolor[x] << "\t||" << Crime[x] << "\t||" << Punishmentmonths[x] << "\t||" << DateofEntry[x]<< endl;
                MyFile_ << "\n"
                        << endl;
                c++;
            }
    ...
    case 2:
        ...
        for (int x = 0; x <= 19; x++)
        {
            if (First_Name[x] != " ")
            {
                ...
                MyFile_ << "<br>";
                MyFile_ << "Date of Entry: " << DateofEntry[x];
                MyFile_ << "<br>";
                MyFile_ << "<br>";
                c++;
            }
    ...
    case 3:
        ...
        for (int x = 0; x <= 19; x++)
        {
            if (First_Name[x] != " ")
            {
                ...
                MyFile_ << "Punishment Months: " << Punishmentmonths[x];
                MyFile_ << "\n";
                MyFile_ << "DateofEntry: " << DateofEntry[x];
                MyFile_ << "\n";
